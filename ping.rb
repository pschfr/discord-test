...
# This is from https://raw.githubusercontent.com/meew0/discordrb/master/examples/ping.rb
...
# I added this though, the token is in a hidden .config file
bot = Discordrb::Bot.new token: JSON.parse(File.read('.config'))['discord_token']
